...
<div class="jtz_news">
  <div class="wrap">
    <div class="part1" id="news">
      <ul class="swiper-wrapper"><?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"get\" data=\"op=get&tag_md5=68b43d43ecdb455e268b690847851bc9&sql=SELECT+%2A+FROM+%60zb_xwzx%60+WHERE+lei%3D%27%E9%80%9A%E7%9F%A5%E5%85%AC%E5%91%8A%27+and+tui%3D1+and+status_del%3D0+ORDER+BY+addtime+DESC&num=5\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}pc_base::load_sys_class("get_model", "model", 0);$get_db = new get_model();$r = $get_db->sql_query("SELECT * FROM `zb_xwzx` WHERE lei='通知公告' and tui=1 and status_del=0 ORDER BY addtime DESC LIMIT 5");while(($s = $get_db->fetch_next()) != false) {$a[] = $s;}$data = $a;unset($a);?>
        ...
        <li class="swiper-slide">
          <div class="con"> <img src="<?php echo IMG_PATH;?>zb/jtz_img4.jpg" style="background-size:cover;"/>
            <div class="box">
              <div class="cen"> <a href="/tzggs-<?php echo $mtbd['id'];?>.html" class="txt"><?php echo intercept($mtbd['title'],0,18);?></a> <span><i class="i1"><?php echo date('Y-m-d',$mtbd['addtime']);?></i><i class="i2"><?php echo $mtbd['hits'];?></i></span> <b><?php echo intercept($mtbd['summer'],0,60);?></b> <a href="/tzggs-<?php echo $mtbd['id'];?>.html" class="a">查看详情<i>>></i></a> </div>
            </div>
          </div>
    ...
    <div class="part2">
      <ul class="ul cf">
       <?php $n=1;if(is_array($qydt)) foreach($qydt AS $arr) { ?>
        <li>
          <dl>
            <dt><a href="/tzggs-<?php echo $arr['id'];?>.html"><img src="<?php echo cutimg($arr['pic'],380,245,5);?>"/></a></dt>
            <dd> <a href="/tzggs-<?php echo $arr['id'];?>.html" class="txt"><?php echo intercept($arr['title'],0,18);?></a> <span><i class="i1"><?php echo date('Y-m-d',$arr['addtime']);?></i><i class="i2"><?php echo $arr['hits'];?></i></span> <a href="/tzggs-<?php echo $arr['id'];?>.html" class="a">查看详情<i>>></i></a> </dd>
          </dl>
        </li>
       <?php $n++;}unset($n); ?>
      </ul>
