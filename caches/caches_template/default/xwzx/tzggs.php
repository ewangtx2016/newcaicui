  ...
  <div class="wrap">
    <div class="box_l">
      <div class="box">
        ...
        <div class="page1 cf"> <a href="/tzgg.html" class="fh">返回列表</a>
          <ul>
            <?php if($upspage['id']!='') { ?><li><b>上一条：</b><a href="/tzggs-<?php echo $upspage['id'];?>.html"><?php echo $upspage['title'];?></a></li><?php } ?>
            <?php if($downspage['id']!='') { ?><li><b>下一条：</b><a href="/tzggs-<?php echo $downspage['id'];?>.html"><?php echo $downspage['title'];?></a></li><?php } ?>
          </ul>
        </div>
      </div>
    </div>
