...
$LANG['aboutus'] = '关于中博';
$LANG['education'] = '创新教育列表';
$LANG['addedu'] = '添加创新教育';
$LANG['educationdel'] = '创新教育回收站';
$LANG['educationdel'] = '创新教育回收站';
$LANG['addcourse'] = '添加发展历程';
$LANG['courselist'] = '发展历程列表';
$LANG['coursedel'] = '发展历程回收站';
$LANG['addpartners'] = '添加合作伙伴';
$LANG['partnerslist'] = '合作伙伴列表';
$LANG['partnersdel'] = '伙伴列表回收站';
$LANG['addhonor'] = '添加企业荣誉';
$LANG['honorlist'] = '企业荣誉列表';
$LANG['honordel'] = '企业荣誉回收站';
$LANG['addfb'] = '添加分部';
$LANG['fblist'] = '分部列表';
$LANG['fbdel'] = '分部回收站';
$LANG['contactus'] = '联系我们';
...
$LANG['qydt'] = '企业动态';
$LANG['qydtadd'] = '添加企业动态';
$LANG['qydtlist'] = '企业动态列表';
$LANG['qydtdel'] = '企业动态回收站';
$LANG['mtbd'] = '媒体报道';
$LANG['mtbdadd'] = '添加媒体报道';
$LANG['mtbdlist'] = '媒体报道列表';
$LANG['mtbdhsz'] = '媒体报道回收站';
$LANG['zyhd'] = '重要活动';
$LANG['zyhdadd'] = '添加重要活动';
$LANG['zyhdlist'] = '重要活动列表';
$LANG['zyhddel'] = '重要活动回收站 ';
$LANG['csrjy'] = '创始人寄语';
$LANG['shgy'] = '社会公益';
$LANG['jxj'] = '奖学金';
$LANG['shgyadd'] = '添加社会公益';
$LANG['shgylist'] = '社会公益列表';
$LANG['shgydel'] = '社会公益回收站';
$LANG['zblladd'] = '添加中博力量';
$LANG['zblllist'] = '中博力量列表';
$LANG['zblldel'] = '中博力量回收站';
$LANG['csrjyedit'] = '创始人寄语';
$LANG['jxjedit'] = '奖学金';
$LANG['sztd'] = '师资团队';
$LANG['sztdadd'] = '添加师资团队';
$LANG['sztdlist'] = '师资团队列表';
$LANG['sztddel'] = '师资团队回收站';
$LANG['cityadd'] = '添加城市';
$LANG['citylist'] = '城市列表';
$LANG['citydel'] = '城市回收站';
$LANG['gyzblm'] = '栏目';
$LANG['gyzblmxx'] = '关于中博栏目信息';
$LANG['ywtxlm'] = '栏目';
$LANG['ywtxlmxx'] = '业务体系栏目信息';
$LANG['xwzxlm'] = '栏目';
$LANG['xwzxlmxx'] = '新闻中心栏目信息';
$LANG['shzrlm'] = '栏目';
$LANG['shzrlmxx'] = '社会责任栏目信息';
$LANG['role_manage'] = '角色管理';
$LANG['zh'] = '首页';
$LANG['sylbt'] = '首页轮播图';
$LANG['sylbtadd'] = '添加首页轮播图';
$LANG['sylbtlist'] = '首页轮播图列表';
$LANG['sylbtdel'] = '首页轮播图回收站';
$LANG['zbyw'] = '中博业务';
$LANG['zbywadd'] = '添加中博业务';
$LANG['zbywlist'] = '中博业务列表';
$LANG['zbywdel'] = '中博业务回收站';
$LANG['zbqxzgs'] = '旗下子公司';
$LANG['qxzgsadd'] = '添加旗下子公司';
$LANG['qxzgslist'] = '旗下子公司列表';
$LANG['qxzgsdel'] = '旗下子公司回收站';
$LANG['tzgg'] = '通知公告';
$LANG['tzggadd'] = '添加通知公告';
$LANG['tzgglist'] = '通知公告列表';
$LANG['tzggdel'] = '通知公告回收站';
$LANG['zbll'] = '中博力量';
$LANG['sz'] = '设置';
$LANG['zblllist'] = '中博力量列表';
$LANG['szs'] = '设置';
$LANG['cxjylmxx'] = '创新教育栏目信息';
$LANG['hzhblmxx'] = '合作伙伴栏目信息';
$LANG['fzlclmxx'] = '发展历程栏目信息';
$LANG['qyrylmxx'] = '企业荣誉栏目信息';
$LANG['jrzblmxx'] = '加入中博栏目信息';
$LANG['sztdlmxx'] = '师资团队栏目信息';
$LANG['lxwmlmxx'] = '联系我们栏目信息';
$LANG['jxjlmxx'] = '奖学金栏目信息';
$LANG['shgylmxx'] = '社会公益栏目信息';
$LANG['csrjylmxx'] = '创始人寄语栏目信息';
$LANG['qydtlmxx'] = '企业动态栏目信息';
$LANG['tzgglmxx'] = '通知公告栏目信息';
$LANG['zyhdlmxx'] = '重要活动栏目信息';
$LANG['mtbdlmxx'] = '媒体报道栏目信息';
?>