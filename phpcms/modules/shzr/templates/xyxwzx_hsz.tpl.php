...
<input type="hidden" value="shzr" name="m">
<input type="hidden" value="xwzx_xy" name="c">
...
<form name="myform" action="index.php?m=shzr&c=xwzx_xy&a=xwzx_xy_hszsc" method="post" onsubmit="checkuid();return false;">
<tbody>
<?php
	if(is_array($datas)){
...
?>
    <tr>
		...
		<td align="center">
            <a href="index.php?m=shzr&c=xwzx_xy&a=xwzx_xy_hszhy&id=<?php echo $v['id']?>">还原</a> |
            <a href="index.php?m=shzr&c=xwzx_xy&a=xwzx_xy_hszsc&id=<?php echo $v['id']?>" onclick="return confirm('您确定删除吗？？')">删除</a>
		</td>
    </tr>
<?php
	}
