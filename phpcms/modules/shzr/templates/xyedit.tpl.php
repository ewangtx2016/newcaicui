...
<form name="myform" id="myform" action="index.php?m=shzr&c=xwzx_xy&a=edit" method="post" enctype="multipart/form-data">
<fieldset>
...
<table class="table_form" width=100%>
    ...
    <tr>
    	<td> 毕业院校</td>
        <td>
        	<input type="text" style="width:600px;" name="info[summer]" id="summer" value="<?php echo $res['summer']?>" />
        </td>
    </tr>
    <tr>
        <td><span style="color:#f00;">*</span> mp3附件</td>
        <td><?php echo $res['files']?><input type="hidden" name="files_hidden" value="<?php echo $res['files']?>"><input type="file" name="files" id="files" /></td>
    </tr>
</table>
</fieldset>
    <div class="bk15"></div>
