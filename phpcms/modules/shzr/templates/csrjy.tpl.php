...
<form name="myform" id="myform" action="index.php?m=shzr&c=xwzx_gy&a=csrjy" method="post" enctype="multipart/form-data">
<fieldset>
	<legend>创始人寄语</legend>
<table class="table_form" width=100%>
    ...
    <tr>
    	<td>图片</td>
        <td>
        	<a class="btn" id="btn">上传图片</a> 1200px * 436px,最大800K，支持jpg，gif，png格式。
