...
$(function(){
	...
	$("#title").formValidator({onshow:"必填",onfocus:"请输入全国分公司"}).inputValidator({min:1,onerror:"不能为空"});
	$("#keywords").formValidator({onshow:"必填",onfocus:"请输入全国教学点"}).inputValidator({min:1,onerror:"不能为空"});
	$("#jianjie").formValidator({onshow:"必填",onfocus:"请输入全国教师团队"}).inputValidator({min:1,onerror:"不能为空"});
	$("#pic4").formValidator({onshow:"必填",onfocus:"请输入累计培养学员"}).inputValidator({min:1,onerror:"不能为空"});
	...
	$("#pic2").formValidator({onshow:"必填",onfocus:"请输入右侧大标题"}).inputValidator({min:1,onerror:"不能为空"});
	$("#pic3").formValidator({onshow:"必填",onfocus:"请输入右侧文字"}).inputValidator({min:1,onerror:"不能为空"});
});
//-->
</script>
<form name="myform" id="myform" action="index.php?m=ywtx&c=ywtx&a=allfb" method="post" enctype="multipart/form-data">
<fieldset>
	<legend>招聘信息</legend>
<table class="table_form" width=100%>
    <tr>
        <td><span style="color:#f00;">*</span> 全国分公司</td>
        <td><input type="text" style="width:600px;" name="info[title]" id="title" value="<?php echo $res['title']?>" class="measure-input "/></td>
    </tr>
    <tr>
        <td><span style="color:#f00;">*</span> 全国教学点</td>
        <td><input type="text" style="width:600px;" name="info[keywords]" id="keywords" value="<?php echo $res['keywords']?>" /></td>
    </tr>
    <tr>
    	<td><span style="color:#f00;">*</span> 全国教师团队</td>
        <td><input type="text" style="width:600px;" name="info[jianjie]" id="jianjie" value="<?php echo $res['jianjie']?>" /></td>
    </tr>
    <tr>
    	<td><span style="color:#f00;">*</span> 累计培养学员</td>
        <td><input type="text" style="width:600px;" name="info[pic4]" id="pic4" value="<?php echo $res['pic4']?>" /></td>
    </tr>
    <tr>
	...
	<tr>
    	<td>图片</td>
        <td>
        	<a class="btn" id="btn">上传图片</a> 695px * 584px,最大800kb，支持jpg，gif，png格式。
	...
	<tr>
    	<td><span style="color:#f00;">*</span> 右侧大标题</td>
        <td><input type="text" style="width:600px;" name="info[pic2]" id="pic2" value="<?php echo $res['pic2']?>" /></td>
    </tr>
    <tr>
    	<td><span style="color:#f00;">*</span> 右侧文字</td>
        <td><input type="text" style="width:600px;" name="info[pic3]" id="pic3" value="<?php echo $res['pic3']?>" /></td>
    </tr>
</table>
</fieldset>
    <div class="bk15"></div>
