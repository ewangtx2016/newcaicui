...
<form name="myform" id="myform" action="index.php?m=ywtx&c=ywtx_city&a=add" method="post" enctype="multipart/form-data">
<fieldset>
	<legend>添加城市</legend>
<table class="table_form" width=100%>
    ...
    <tr>
        ...
        <td><input type="text" style="width:600px;" name="info[url]" id="url" value="http://" /></td>
    </tr>
