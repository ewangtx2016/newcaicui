...
$(function(){
	...
	$("#company").formValidator({onshow: "必填",onfocus: "请输入名称"}).inputValidator({min:1,max:88,onerror:"不能超过88个字"}).ajaxValidator({
		type : "get",
		url : "",
		data :"m=ywtx&c=ywtx_city&a=get_title&hiddenid="+$('#hidden_id').val(),
		datatype : "html",
		async:'false',
...
<form name="myform" id="myform" action="index.php?m=ywtx&c=ywtx_city&a=edit" method="post" enctype="multipart/form-data">
<fieldset>
	<legend>编辑城市</legend>
