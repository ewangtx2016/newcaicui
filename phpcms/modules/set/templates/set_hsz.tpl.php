...
?>
    <tr>
		...
		<td align="center">
            <a href="index.php?m=set&c=set&a=set_hszhy&id=<?php echo $v['id']?>">还原</a> |
            <a href="index.php?m=set&c=set&a=set_hszsc&id=<?php echo $v['id']?>" onclick="return confirm('您确定删除吗？？')">删除</a>
		</td>
    </tr>
<?php
	}
