...
<input type="hidden" value="set_yw" name="c">
...
<form name="myform" action="index.php?m=set&c=set_yw&a=delete" method="post" onsubmit="checkuid();return false;">
<tbody>
<?php
	if(is_array($datas)){
...
?>
    <tr>
		...
		<td align="center"><?php echo $v['one']?></td>
		...
		<td align="center">
            <a href="index.php?m=set&c=set_yw&a=set_yw_hszhy&id=<?php echo $v['id']?>">还原</a> |
            <a href="index.php?m=set&c=set_yw&a=set_yw_hszsc&id=<?php echo $v['id']?>" onclick="return confirm('您确定删除吗？？')">删除</a>
		</td>
    </tr>
<?php
	}
