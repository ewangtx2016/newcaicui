...
<form name="myform" id="myform" action="index.php?m=set&c=set&a=edit" method="post" enctype="multipart/form-data">
<fieldset>
	<legend>编辑首页轮播图</legend>
<table class="table_form" width=100%>
    ...
    <tr>
        ...
        <td><img src="<?php echo cutimg($res['pic'],100,100,5) ?>"><input type="hidden" name="pic_hidden" value="<?php echo $res['pic']?>"><input type="file" name="pic" id="pic" />1900px * 798px，支持jpg，gif，png格式。</td>
    </tr>
    <tr>
        <td><span style="color:#f00;">*</span> 小图片</td>
        <td><img src="<?php echo cutimg($res['pic2'],100,100,5) ?>"><input type="hidden" name="pic2_hidden" value="<?php echo $res['pic2']?>"><input type="file" name="pic2" id="pic2" />940px * 309px，请上传png格式。</td>
    </tr> 
    <tr>
