...
$(function(){
	...
	$("#title").formValidator({onshow: "必填",onfocus: "请输入标题"}).inputValidator({min:1,max:88,onerror:"不能超过88个字"}).ajaxValidator({
		type : "get",
		url : "",
		data :"m=set&c=set_zgs&a=get_title&hiddenid="+$('#hidden_id').val(),
		datatype : "html",
		async:'false',
	...
	$("#one").formValidator({onshow:"必填",onfocus:"请输入中文名"}).inputValidator({min:1,onerror:"不能为空"});
});
//-->
</script>
<div class="pad-10">
<div class="common-form">
<form name="myform" id="myform" action="index.php?m=set&c=set_zgs&a=add" method="post" enctype="multipart/form-data">
<fieldset>
	<legend>添加旗下子公司</legend>
<table class="table_form" width=100%>
    <tr><input type="hidden" name="info[lei]" id="lei" value="中博旗下子公司">
    	<td>LOGO</td>
        <td>
        	<a class="btn" id="btn">上传图片</a> 256px * 37px,最大800kb，只能上传png格式。
