...
?>
    <tr>
		...
		<td align="center">
            <a href="index.php?m=set&c=set_yw&a=edit&id=<?php echo $v['id']?>">编辑</a> |
            <a href="index.php?m=set&c=set_yw&a=delete&id=<?php echo $v['id']?>" onclick="return confirm('您确定删除吗？？')">删除</a>
		</td>
    </tr>
<?php
	}
