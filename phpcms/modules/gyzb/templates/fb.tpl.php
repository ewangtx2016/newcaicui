...
<form name="myform" action="index.php?m=gyzb&c=gyzb_fb&a=delete" method="post" onsubmit="checkuid();return false;">
<tbody>
<?php
	if(is_array($datas)){
...
?>
    <tr>
		...
		<td align="center">
            <a href="index.php?m=gyzb&c=gyzb_fb&a=edit&id=<?php echo $v['id']?>">编辑</a> |
            <a href="index.php?m=gyzb&c=gyzb_fb&a=delete&id=<?php echo $v['id']?>" onclick="return confirm('您确定删除吗？？')">删除</a>
		</td>
    </tr>
<?php
	}
