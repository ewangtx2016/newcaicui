...
<form name="myform" id="myform" action="index.php?m=gyzb&c=gyzb_sztd&a=add" method="post" enctype="multipart/form-data">
<fieldset>
	<legend>添加师资团队</legend>
<table class="table_form" width=100%>
    ...
    <tr>
        ...
        <td><input type="file" name="pic" id="pic" />380px * 353px</td>
    </tr>
    <tr>
        <td><span style="color:#f00;">*</span> 图片2</td>
        <td><input type="file" name="pic2" id="pic2" />1134px * 436px</td>
    </tr> 
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" style="width:600px;" name="info[ren]" id="ren" value="" /></td>
	</tr>
   <tr>
        <td><span style="color:#f00;">*</span> 英文名</td>
        <td><input type="text" style="width:600px;" name="info[english]" id="english" value="" /></td>
	</tr>
   <tr>
        <td><span style="color:#f00;">*</span> 摘要</td>
        <td><textarea name="info[summer]" id="summer" style="width:600px;height:100px;"></textarea></td>
	</tr>
   <tr>
        <td><span style="color:#f00;">*</span> 教师资历</td>
        <td><input type="text" style="width:600px;" name="info[jszl]" id="jszl" value="" /></td>
	</tr>
   <tr>
        <td><span style="color:#f00;">*</span> 主讲科目</td>
        <td><input type="text" style="width:600px;" name="info[zjkm]" id="zjkm" value="" /></td>
	</tr>
   <tr>
        <td><span style="color:#f00;">*</span> 从业时间</td>
        <td><input type="text" style="width:600px;" name="info[cysj]" id="cysj" value="" /></td>
	</tr>
   <tr>
        <td><span style="color:#f00;">*</span> 讲师格言</td>
        <td><input type="text" style="width:600px;" name="info[jsgy]" id="jsgy" value="" /></td>
	</tr>
	<tr>
       <td><span style="color:#f00;">*</span> 教师简介</td>
        <td>
			<?PHP pc_base::load_sys_class('form','',0);?>
            <textarea name="info[jsjj]" id="jsjj"></textarea>
	...
	<tr>
       <td><span style="color:#f00;">*</span> 教育背景</td>
        <td>
			<?PHP pc_base::load_sys_class('form','',0);?>
            <textarea name="info[jybj]" id="jybj"></textarea>
	...
	<tr>
       <td><span style="color:#f00;">*</span> 工作经历</td>
        <td>
			<?PHP pc_base::load_sys_class('form','',0);?>
            <textarea name="info[gzjl]" id="gzjl"></textarea>
