...
<form name="myform" action="index.php?m=gyzb&c=gyzb_job&a=job_hszsc" method="post" onsubmit="checkuid();return false;">
<tbody>
<?php
	if(is_array($datas)){
...
?>
    <tr>
		...
		<td align="center">
            <a href="index.php?m=gyzb&c=gyzb_job&a=job_hszhy&id=<?php echo $v['id']?>">还原</a> |
            <a href="index.php?m=gyzb&c=gyzb_job&a=job_hszsc&id=<?php echo $v['id']?>" onclick="return confirm('您确定删除吗？？')">删除</a>
		</td>
    </tr>
<?php
	}
