...
$(function(){
	...
	$("#company").formValidator({onshow: "必填",onfocus: "请输入名称"}).inputValidator({min:1,max:88,onerror:"不能超过88个字"}).ajaxValidator({
		type : "get",
		url : "",
		data :"m=gyzb&c=gyzb_cxjy&a=get_title&hiddenid="+$('#hidden_id').val(),
		datatype : "html",
		async:'false',
...
<form name="myform" id="myform" action="index.php?m=gyzb&c=gyzb_cxjy&a=edit" method="post" enctype="multipart/form-data">
<fieldset>
	<legend>编辑创新教育</legend>
<table class="table_form" width=100%>
    ...
    <tr>
    	<td>图片</td>
        <td>
        	<a class="btn" id="btn">上传图片</a> 46px * 46px,最大800kb，支持jpg，gif，png格式。
