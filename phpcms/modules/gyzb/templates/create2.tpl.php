...
<form name="myform" id="myform" action="index.php?m=gyzb&c=gyzb_cxjy&a=create2" method="post" enctype="multipart/form-data">
<fieldset>
	<legend>创新教育栏目信息</legend>
<table class="table_form" width=100%>
    ...
    <tr>
    	<td>图片</td>
        <td>
        	<a class="btn" id="btn">上传图片</a> 1900px * 398px,最大800kb，支持jpg，gif，png格式。
...
</div><script type="text/javascript" src="<?php echo JS_PATH?>plupload/plupload.full.min.js"></script>
