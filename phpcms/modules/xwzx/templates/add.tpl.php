...
<form name="myform" id="myform" action="index.php?m=xwzx&c=xwzx&a=add" method="post" enctype="multipart/form-data">
<fieldset>
	<legend>添加企业动态</legend>
<table class="table_form" width=100%>
    <tr><input type="hidden" name="info[lei]" id="lei" value="企业动态">
