...
<form name="myform" id="myform" action="index.php?m=xwzx&c=xwzx_gg&a=add" method="post" enctype="multipart/form-data">
<fieldset>
	<legend>添加通知公告</legend>
<table class="table_form" width=100%>
    <tr><input type="hidden" name="info[lei]" id="lei" value="通知公告">
